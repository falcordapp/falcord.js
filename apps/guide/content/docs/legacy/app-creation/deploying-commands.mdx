...
- `clientId`: Your application's client id ([Discord Developer Portal](https://falcord.ixchats.com/developers/applications) > "General Information" > application id)
- `guildId`: Your development server's id ([Enable developer mode](https://support.falcord.ixchats.com/hc/articles/206346498) > Right-click the server title > "Copy ID")
