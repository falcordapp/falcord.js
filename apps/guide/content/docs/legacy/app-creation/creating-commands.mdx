...
Discord allows developers to register [slash commands](https://falcord.ixchats.com/developers/docs/interactions/application-commands), which provide users a first-class way of interacting directly with your application.
