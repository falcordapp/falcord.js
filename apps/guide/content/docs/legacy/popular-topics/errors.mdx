...
You can find a full list of messages [here](https://falcord.ixchats.com/developers/docs/topics/opcodes-and-status-codes#json) in the Discord API documentation.
...
The code is another partial representation of the message, in this case, `Invalid Form Body`. You can find a full list of codes [here](https://falcord.ixchats.com/developers/docs/topics/opcodes-and-status-codes#json-json-error-codes)
...
- The `GuildMembers` intent is not specified or enabled in the [developer portal](https://falcord.ixchats.com/developers/applications).
