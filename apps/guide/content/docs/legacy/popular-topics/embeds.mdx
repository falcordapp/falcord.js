...
- Discord may strip characters from message content. See [the documentation](https://falcord.ixchats.com/developers/docs/resources/message#create-message) for more information
...
Source: [Discord API documentation](https://falcord.ixchats.com/developers/docs/resources/message#embed-object-embed-limits)
