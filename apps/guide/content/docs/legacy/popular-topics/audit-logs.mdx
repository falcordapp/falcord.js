...
There are quite a few cases where you may use audit logs. This guide will limit itself to the most common use cases. Feel free to consult the [relevant Discord API page](https://falcord.ixchats.com/developers/docs/resources/audit-log) for more information.
