...
<Callout>
	...
	types](https://falcord.ixchats.com/developers/docs/interactions/application-commands#subcommands-and-subcommand-groups).
</Callout>
...
The names and descriptions of slash commands can be localized to the user's selected language. You can find the list of accepted locales on the [discord API documentation](https://falcord.ixchats.com/developers/docs/reference#locales).
