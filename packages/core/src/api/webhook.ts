...
export class WebhooksAPI {
	 ...
	 * Fetches a webhook
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#get-webhook}
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#get-webhook-with-token}
	 ...
	 * Edits a webhook
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#modify-webhook}
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#modify-webhook-with-token}
	 ...
	 * Deletes a webhook
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#delete-webhook}
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#delete-webhook-with-token}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#execute-webhook}
	 * @param id - The id of the webhook
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#execute-slackcompatible-webhook}
	 * @param id - The id of the webhook
	 * @param token - The token of the webhook
	 * @param body - The data for executing the webhook
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#execute-githubcompatible-webhook}
	 * @param id - The id of the webhook
	 * @param token - The token of the webhook
	 * @param body - The data for executing the webhook
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#get-webhook-message}
	 * @param id - The id of the webhook
	 * @param token - The token of the webhook
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#edit-webhook-message}
	 * @param id - The id of the webhook
	 * @param token - The token of the webhook
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/webhook#delete-webhook-message}
	 * @param id - The id of the webhook
	 * @param token - The token of the webhook
