...
export class UsersAPI {
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#get-user}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#get-current-user}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#get-current-user-guilds}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#leave-guild}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#modify-current-user}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#get-current-user-guild-member}
	 * @param guildId - The id of the guild
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/guild#modify-current-member}
	 * @param guildId - The id of the guild
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#create-dm}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#get-user-connections}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#get-user-application-role-connection}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/user#update-user-application-role-connection}
	 * @param applicationId - The id of the application
