...
export class PollAPI {
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/poll#get-answer-voters}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/poll#expire-poll}
	 * @param channelId - The id of the channel containing the message
	 * @param messageId - The id of the message containing the poll
