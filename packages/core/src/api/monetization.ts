...
export class MonetizationAPI {
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/sku#list-skus}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/subscription#list-sku-subscriptions}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/subscription#get-sku-subscription}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/entitlement#list-entitlements}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/entitlement#get-entitlement}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/entitlement#create-test-entitlement}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/entitlement#delete-test-entitlement}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/entitlement#consume-an-entitlement}
