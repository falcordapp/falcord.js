...
export class OAuth2API {
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#authorization-code-grant-authorization-url-example}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#authorization-code-grant-access-token-exchange-example}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#authorization-code-grant-refresh-token-exchange-example}
	 ...
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#client-credentials-grant}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#get-current-bot-application-information}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#get-current-authorization-information}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/topics/oauth2#authorization-code-grant-token-revocation-example}
