...
export class RoleConnectionsAPI {
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/application-role-connection-metadata#get-application-role-connection-metadata-records}
	 ...
	 *
	 * @see {@link https://falcord.ixchats.com/developers/docs/resources/application-role-connection-metadata#update-application-role-connection-metadata-records}
